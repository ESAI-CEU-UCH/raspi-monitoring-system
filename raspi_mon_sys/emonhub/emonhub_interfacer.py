"""
  ...
  Updated by Francisco Zamora-Martinez to be compatible with
...
class EmonHubSerialInterfacer(EmonHubInterfacer):
    ...
    def __init__(self, name, logger, com_port='', com_baud=9600):
        ...
        # Initialization
        super(EmonHubSerialInterfacer, self).__init__(name, logger)
...
class EmonHubJeeInterfacer(EmonHubSerialInterfacer):
    ...
    def __init__(self, name, logger, com_port='/dev/ttyAMA0', com_baud=0):
        """Initialize Interfacer
        ...
        # Initialization
        if com_baud != 0:
            super(EmonHubJeeInterfacer, self).__init__(name, logger, com_port, com_baud)
        else:
...
class EmonHubSocketInterfacer(EmonHubInterfacer):
    ...
    def __init__(self, name, logger, port_nb=50011):
        """Initialize Interfacer
        ...
        # Initialization
        super(EmonHubSocketInterfacer, self).__init__(name, logger)
